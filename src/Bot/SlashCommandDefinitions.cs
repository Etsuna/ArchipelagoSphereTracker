...
public static class SlashCommandDefinitions
{
    ...
    {
        yield return BuildAstCommand();

        foreach (var command in GetLegacyCommands())
            yield return command;
    }

    private static SlashCommandBuilder BuildAstCommand()
    {
    ...
    private static IEnumerable<SlashCommandBuilder> GetLegacyCommands()
    {
        var commands = new List<SlashCommandBuilder>
        {
            ...
            new SlashCommandBuilder()
                ...
                .WithDescription(Resource.SCSpoilerAnalyzeDescription)
                .AddOption(AliasOption("alias"))
                .AddOption(new SlashCommandOptionBuilder()
                    .WithName("sphere")
                    .WithDescription(Resource.SCSpoilerSphereDescription)
                    .WithType(ApplicationCommandOptionType.Integer)
                    .WithRequired(false))
                .AddOption(new SlashCommandOptionBuilder()
                    .WithName("missing-mode")
                    .WithDescription(Resource.SCSpoilerMissingModeDescription)
                    .WithType(ApplicationCommandOptionType.String)
                    .WithRequired(false)
                    .AddChoice(Resource.SCSpoilerChoiceLowestSphereOnly, "first")
                    .AddChoice(Resource.SCSpoilerChoiceFull, "full"))
                .AddOption(new SlashCommandOptionBuilder()
                    .WithName("hide-items")
                    .WithDescription(Resource.SCSpoilerHideItemsDescription)
                    .WithType(ApplicationCommandOptionType.Boolean)
                    .WithRequired(false))
                .AddOption(new SlashCommandOptionBuilder()
                    .WithName("validate-sphere")
                    .WithDescription(Resource.SCSpoilerValidateSphereDescription)
                    .WithType(ApplicationCommandOptionType.Integer)
                    .WithMinValue(0)
                    .WithRequired(false))
                .AddOption(new SlashCommandOptionBuilder()
                    .WithName("reset-validation")
                    .WithDescription(Resource.SCSpoilerResetValidationDescription)
                    .WithType(ApplicationCommandOptionType.Boolean)
                    .WithRequired(false)),

            new SlashCommandBuilder()
                .WithName("send-spoiler-log")
                .WithDescription(Resource.SCSpoilerUploadDescription)
                .AddOption(new SlashCommandOptionBuilder()
                    .WithName("file")
                    .WithDescription(Resource.SCSpoilerFileDescription)
                    .WithType(ApplicationCommandOptionType.Attachment)
                    .WithRequired(true)),

            new SlashCommandBuilder().WithName("apworlds-info").WithDescription(Resource.SCApworldInfoDescription),
            new SlashCommandBuilder().WithName("discord").WithDescription(Resource.DiscordDesc),
            ...
            new SlashCommandBuilder().WithName("excluded-item-list").WithDescription(Resource.SCExcludedItemListDesc),
            ...
            new SlashCommandBuilder().WithName("ast-user-portal").WithDescription(Resource.SCPortalLinkDescription),
            new SlashCommandBuilder().WithName("ast-room-portal").WithDescription("Afficher la page web des commandes du thread"),
            new SlashCommandBuilder().WithName("ast-portal").WithDescription(Resource.SCPortalUrlDescription)
        };
            ...
            commands.AddRange(new[]
            {
                ...
                new SlashCommandBuilder()
                    ...
                    .AddOption(new SlashCommandOptionBuilder()
                        ...
                        .WithType(ApplicationCommandOptionType.Attachment)
                        .WithRequired(true))
                    .AddOption(BooleanOption("skip-prog-balancing", "skip-prog-balancing")),
    ...
    private static SlashCommandOptionBuilder FrequencyOption()
    {
        return new SlashCommandOptionBuilder()
    ...
    private static SlashCommandOptionBuilder ItemsOption(string name)
    {
        return new SlashCommandOptionBuilder()
            .WithName(name)
